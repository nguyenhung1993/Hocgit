...
<head>
    ...
    <title>注文住宅の電気工事なら | 名宝電気工事株式会社 - 名古屋市中村区</title>
    <link rel="shortcut icon" href="../favicon.ico" type="image/x-icon">
    <link rel="icon" href="../favicon.ico" type="image/x-icon">
    <meta name="description" content="名宝電気工事は、名古屋市中村区にある電気工事会社です。新築デザイナーズ注文住宅の電気工事や、オフィス・工場の配線工事、大型施設の高圧受電設備など、幅広く対応しております。">
    <meta name="keyword" content="名宝電気工事, 名古屋市, 電気工事士">
...
<main class="main-content page-contact-confirm">
    <section class="page-head-banner txt-center page-contact-confirm">
        <div class="container container-md">
            <h2>お問い合わせ</h2>
            <p>CONTACT</p>
    ...
    <section class="section-contact-form">
        <form class="frm-contact" class="confirm_form" method="POST" action="<?php he($form->setting->getUrl('send')) ?>">
            <div class="contact-form-heading">
                <div class="container container-xs">
                    <p class="notice">この内容でよろしいですか？</p>
                </div>
            </div>
                ...
                <div class="container container-sm">
                    <div class="form-row">
                        ...
                        <div class="form-content">
                            <p><?php $form->view($p, 'fContentOfInquiry') ?></p>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-label">
                        ...
                        <div class="form-content">
                            <p><?php $form->view($p, 'fOccupation') ?></p>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-label">
                        ...
                        <div class="form-content">
                            <p><?php $form->view($p, 'fFirstName') ?></p>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-label">
                        ...
                        <div class="form-content">
                            <p><?php $form->view($p, 'fPhoneNumber') ?></p>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-label">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-content">
                            <p>
                                <?php $form->view($p, 'fComment') ?>
                            </p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="contact-form-footer page-contact-confirm">
                <div class="container container-sm txt-center">
                    ...
                    <a onclick="location.href='<?php he($form->setting->getUrl('input')) ?>?from=confirm'; return false;" class="btn btn-solid-yellow">
