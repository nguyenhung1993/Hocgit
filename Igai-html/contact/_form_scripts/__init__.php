...
class Form
{
    ...
    public function send()
    {
        ...
        $subject       = "【".aget($params, 'name')."様】".$this->setting->mailSubject();
...
class Form_Validator
{
    ...
    // 上部セレクトボックス 1番目
    public function __job($options)
    {
        return $this->checkText('job', 255, $options);
    }

    // 名前
    public function __name($options)
    {
        return $this->checkText('name', 50, $options);
    }
    ...
    // 性別
    public function __sex($options)
    {
        return $this->checkSelect('sex', $options);
    }
    ...
    // メールアドレス
    public function __mail($options)
    {
        return $this->checkMail('mail', $options);
    }
    ...
    // ご意見・ご質問
    public function __content($options)
    {
        return $this->checkText('content', 2000, $options);
    }
