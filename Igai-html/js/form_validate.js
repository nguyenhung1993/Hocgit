                ...
                .done(function(data) {
                    if (data.valid == "true") {
                        ...
                        $.each(data.errors, function(key, value) {
                            ...
                            var error_msg_block = $('div.error-message').find('.' + key);
                            ...
                            if (error_msg_block.length){
                                ...
                                $( ".error-message" ).after('<p class="'+key+'"><span>' + value + '</span></p>');
                                //error_msg_block.html('aaaa');
                            }
                        });
                        $('html, body').stop().animate({
                            scrollTop: $('.section-contact-from').offset().top - 160
                        }, 400);
                        $('.notice.contact').hide();
